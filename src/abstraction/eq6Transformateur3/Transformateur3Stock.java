...
public class Transformateur3Stock {
    ...
    public Transformateur3Stock(Transformateur3Acteur acteur, Journal journal, String nomProduit, List<IProduit> listProduit, HashMap<IProduit, Variable> indicateurs){
