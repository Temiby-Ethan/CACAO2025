...
public class Variable implements Comparable<Variable>{
	...
	/**
	 * Version pour les variables a acces illimite
	 * Sans verification du cryptogramme car l'acces est
	 * ouvert a tous a la fois en lecture et ecriture.
	 * (Methode surchargee pour les variables a acces restreint)
	 */
